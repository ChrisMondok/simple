...
const testsWithSetupAndTeardown = new Simple.Context("Tests With Setup and Teardown", new TestObject());

testsWithSetupAndTeardown.setup = function() { this.value = "unchanged"; };

testsWithSetupAndTeardown.teardown = function() { this.increment(); };
...
module.exports = testsWithSetupAndTeardown;
